...
nm_setting_ip6_config_class_init (NMSettingIP6ConfigClass *ip6_class)
{
	 ...
	 *
	 * If the property is unset, its value will be searched in the default connection
	 * settings; if not found, the value defaults to "lease".
	 *
	 * Since: 1.12
	 **/
	/* ---ifcfg-rh---
	 ...
	 *   format is expected. An hex value where each octet is separated by a colon is
	 *   also accepted.
